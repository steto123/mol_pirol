...
4. Install all dependencies: `pip install pandas numpy torch PyQt5 rdkit tf-keras nfp`
...
4. Installieren Sie alle Abhängigkeiten: `pip install pandas numpy torch PyQt5 rdkit tf-keras nfp`
